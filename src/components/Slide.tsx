...
import AnswerItemV2 from "./AnswerItemV2";
import SlideQuizz from "./SlideQuizz";
...
const Slide: React.FC = () => {
  ...
  return (
    <Box h='calc(100vh)' backgroundColor="gray.200">
      {/* <Flex w="full" h="full"> */}
      ...
      {/* <Box flexGrow="1" h="full" backgroundColor="gray.200"> */}
      <Flex
        h="full"
        direction="column"
      ...
      >
        <Box w="full" boxShadow="md" mt="10">
          <Text className="w-full py-3 rounded-md outline-none px-10 text-5xl text-center font-medium">this is for question</Text>
          {/* <input
                type="text"
                ref={contentRef}
                defaultValue="this is for question"
                onChange={(e) => {
          ...
          {/* <Box>
              <Avatar
                ...
                icon={
                  ...
                  // />
                  <Text className="w-full bg-inherit outline-none m-5 text-white text-center">10</Text>
                }
              />
