    ...
    <Box w="60%" mx="auto" mt="10">
      ...
      <Tabs index={tabIndex} onChange={handleTabsChange}>
        ...
        <TabPanels>
              ...
              <Box p={5} maxW='60%' height={200} borderWidth='1px' borderRadius='lg' overflow='hidden'>
                <HStack spacing={4}>
                  ...
                  <Box maxW='70%'>
                    ...
                    <Text>Play again and let the same group improve their score or see if new players can beat this result.</Text>
                ...
                <Flex minH='100%' alignItems='center' justifyContent='center'>
                  <TableContainer minH='100%'>
                    <Table variant='unstyled' >
                      <Tbody>
                        <Tr>
                          <Td><ImUser size={25} color='purple' /></Td>
                          <Td><Text _hover={{ color: "green", cursor: 'pointer', }} onClick={() => handleTabsChange(1)}>Players</Text></Td>
                          <Td isNumeric><Text align='right'>{report?.count_players}</Text></Td>
                        </Tr>
                        <Tr>
                          <Td><ImQuestion size={25} color='blue' /></Td>
                          <Td><Text _hover={{ color: "green", cursor: 'pointer', }} onClick={() => handleTabsChange(2)}>Questions</Text></Td>
                          <Td isNumeric><Text align='right'>{report?.count_questions}</Text></Td>
                        </Tr>
                        <Tr border='0'>
                          <Td><ImClock size={25} color='green' /></Td>
                          <Td>Time</Td>
                          <Td isNumeric><Text align='right'>1 min</Text></Td>
                        </Tr>
                      </Tbody>
                    </Table>
                  </TableContainer>
          ...
          <TabPanel>
            { report ? <TabPlayer report_id={report.report_id} /> : <></> }
          </TabPanel>
          <TabPanel>
            { report ? <TabQuestion game_id={report.game_id} /> : <></> }
          </TabPanel>
        </TabPanels>
      </Tabs>
    </Box>
